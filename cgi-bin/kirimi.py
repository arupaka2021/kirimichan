...
<body>
	...
	<form action="sum_calorie.py" method="post">
		...
		<div class="content">
			...
			<input type="text" name="other1" id="text_menu1" value="" maxlength=10 disabled><br>
		...
		<div class="content">
			...
			<input type="text" name="other2" id="text_menu2" value="" maxlength=10 disabled><br>
		...
		<div class="content">
			...
			<input type="text" name="other3" id="text_menu3" value="" maxlength=10 disabled><br>
		...
		<div class="content">
			...
			<input type="text" name="other4" id="text_menu4" value="" maxlength=10 disabled><br>
		...
		<div class="content">
			...
			<input type="text" name="other5" id="text_menu5" value="" maxlength=10 disabled><br>
